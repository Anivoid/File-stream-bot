...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7270620723:AAH80-ii-aQTl2xTUG0N4VM5G5iyndCj5Ok")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Huofilebot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002191406958"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "7102263732"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://accha:phir@cluster0.dm1k9xf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002088432628")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002191406958")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://graph.org/file/32549e9fa6f9e31a0c034.jpg")
...
🤖 **ᴍʏ ɴᴀᴍᴇ:** [ꜰɪʟᴇꜱ ꜱᴛᴏʀᴇ ʙᴏᴛ](https://t.me/Huofilebot)
...
🧑🏻‍💻 **ᴅᴇᴠʟᴏᴘᴇʀ:** [ᴀᴋᴋɪ](https://t.me/ariesaep)

👥 **ʜᴀɴɪꜰʟɪx:** [ʜᴇɴᴛᴀɪ](https://t.me/ongoing_haniflix)

📢 **ᴊᴀᴠꜰʟɪx:** [ʟɪᴠᴇ ᴀᴄᴛɪᴏɴ](https://t.me/+_klqs93gEstkYzk1)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/waifuae'>**Waifu** </a>

<a href=''https://t.me/waifuae>Waifu</a> Oil up. 
[Donate Now](https://t.me/waifuae) (Paytm)
"""
	LAZY_HOME_TEXT = """
